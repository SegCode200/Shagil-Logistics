          ...
          <section className="panel">
            <form className="panel-body" onSubmit={(event) => { event.preventDefault(); setNotice(""); create.mutate(); }}>
              <div className="form-grid">
                ...
                <div className="field"><label htmlFor="owner-customer-whatsapp">WhatsApp number</label><input className="input" id="owner-customer-whatsapp" type="tel" placeholder="Defaults to phone number" value={draft.whatsappPhone} onChange={(event) => setDraft({ ...draft, whatsappPhone: event.target.value })} /></div>
